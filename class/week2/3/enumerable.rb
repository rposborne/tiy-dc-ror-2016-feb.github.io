array = %w(Zeke Yvonne Xavier Willa Victor)
...
# end
lowercase_names = array.map(&:downcase)
...
# end
consonant_names = array.reject { |n| %w(a e i o u).include?(n[-1]) }
...
# end
total_letters = array.inject(&:length)
